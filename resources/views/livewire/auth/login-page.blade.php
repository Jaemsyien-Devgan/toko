        ...
        <div
            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="flex flex-row justify-center items-center space-x-3">
                    <a wire:navigate href="https://www.behance.net/ajeeshmon" target="_blank"
                    ...
                    </a><a wire:navigate href="https://twitter.com/ajeemon?lang=en" target="_blank"
                    ...
                    </a><a wire:navigate href="https://in.linkedin.com/in/ajeeshmon" target="_blank"
                ...
                <form class="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a wire:navigate href="/forgot" class="text-indigo-400 hover:text-blue-500">
                    ...
                    <p class="flex flex-row items-center justify-center mt-10 text-center text-md text-gray-500">
                        ...
                        <a wire:navigate href="/register"
                            class="pl-1 text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Register</a>
                    </p>
                </form>
            </div>
        </div>
