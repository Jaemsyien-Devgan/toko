                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between gap-2 ">
                                <span
                                    class="text-sm inline-block font-bold text-blue-400 ">{{ Number::currency(1000000, 'IDR') }}</span>
                                <span
                                    class="inline-block text-sm font-bold text-blue-400 ">{{ Number::currency(100000000, 'IDR') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
