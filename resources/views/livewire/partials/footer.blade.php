    ...
    <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
      <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
        <div class="md:w-[316px]">
          ...
          <h1 class="flex items-center text-white font-extrabold">
            <img src="https://www.svgrepo.com/show/499962/music.svg" class="h-6 mr-3 sm:h-9" alt="DEVSHOP Logo">
            <span class="text-rose-600">DEV</span>SHOP
          </h1>
          </p>
          <p class="mt-[18px] text-[15px] font-normal text-white/[80%] text-justify">DEVSHOP adalah platform e-commerce yang menyediakan koleksi eksklusif pakaian, aksesoris, sepatu, perhiasan, dan tas dari brand-brand ternama. Dengan desain modern dan berkelas, DevShop memberikan pengalaman belanja yang mudah dan nyaman, memenuhi gaya hidup fashionista dengan produk-produk berkualitas tinggi.</p>
          <div class="mt-[18px] flex gap-4">
            <a class="hover:scale-110" target="_blank"

              href="#"><img alt="facebook icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('icon/social.png') }}" ></a><a
              class="hover:scale-110" target="_blank"
              href="/"><img alt="linkdin icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('icon/linkedin.png') }}" ></a><a
              class="hover:scale-110" target="_blank"
              href="/"><img alt="instagram icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('icon/instagram.png') }}" ></a><a
              class="hover:scale-110" target="_blank"
              href=""><img alt="twitter icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('icon/twitter.png') }}" ></a><a
              class="hover:scale-110" target="_blank"
              href="https://www.youtube.com/"><img alt="youtube icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('icon/youtube.png') }}" ></a>
          </div>
        </div>
        <div class="md:w-[316px]">
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium text-white">+62 821226975425</a>
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">adev@gmail.com</a>
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">Lamongan, Jawa Timur,
                Indonesia, 123456</a>
        ...
        <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
          <div class="">
            ...
            <ul>
              ...
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/products">All Product</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="/products">Featured Product</a></li>
              <li class="mt-[15px]"><a
                  class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                  href="#">About Us</a></li>
              <li class="mt-[15px]"><a
          ...
          <div class="mt-6 flex flex-col gap-4 sm:mt-0">
            ...
            <div class="flex gap-4 sm:flex-col">
              <a target="_blank"
                href="#"><img alt="facebook icon" loading="lazy" width="168" height="50" decoding="async" data-nimg="1" style="color:transparent" class="border border-white border-1 rounded-lg" src="{{ asset('icon/plyastore.png') }}" ></a><a
                target="_blank"
                href="#"><img alt="facebook icon" loading="lazy" width="168" height="50" decoding="async" data-nimg="1" style="color:transparent" class="border border-white border-1 rounded-lg" src="{{ asset('icon/appstore.png') }}" ></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-center pb-8 pt-[9px] md:py-8">
        <p class="text-[10px] font-normal text-white md:text-[12px]">
          © Copyright
          <!-- -->2024
          <!-- -->, All Rights Reserved by Devshop.
        </p>
      </div>
    </div>
  </div>
