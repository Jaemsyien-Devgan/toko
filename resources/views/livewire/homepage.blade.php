    <div class="w- full bg-white">
        ...
        <!--- Hero Section -->
        <div class="w-full h-screen bg-cover  px-4 sm:px-6 lg:px-8 mx-auto"
            style="background-image: url('/images/svg.svg');">
                ...
                <div class="py-2 w-full mx-auto items-center">
                    <div class="ml-6 lg:w-1/2 lg:my-8 lg:py-16">
                        <h1
                            ...
                            E-commerce <span
                                class="bg-[#0f430f] inline-block text-transparent bg-clip-text">Devshop</span>
                        </h1>
                        <p class="mt-3 text-lg font-semibold text-justify text-gray-800 dark:text-gray-400">Dapatkan
                            penawaran eksklusif
                            dan update
                            terkini tentang produk-produk mewah dari Devshop. Belanja sekarang untuk menemukan fashion
                            yang
                            sesuai
                            dengan kepribadian Anda.</p>
        ...
        <!-- Card Category -->
        <div class="w-full bg-white">
            <div class=" bg-white max-w-7xl mx-auto p-4 pb-16 items-center">
                {{-- titile --}}
                <div class="max-w-7xl mx-auto">
                    <h1 class=" pl-4 ml-4 text-2xl font-bold mb-6  text-[#0f430f] py-6">Shop Our Top Categories</h1>
                </div>
                ...
                {{-- card product --}}
                <div class="bg-white max-w-7xl mx-auto p-4 pb-2">
                    <h1 class="lg:ml-4 text-2xl font-bold mb-6 text-[#0f430f] pt-12">Today Best Deals For You</h1>

                    <!-- Card Container -->
                    <div class="flex flex-nowrap gap-12 overflow-x-auto max-w-full p-4">
                        <!-- Card -->
                        <div
                            class="bg-white rounded-lg shadow-xl p-2 w-full sm:w-48 md:w-60 lg:w-64 relative flex-shrink-0">
                            <div class="relative bg-[#fff1f1]">
                                <img src="{{ asset('gambar/clothes.png') }}" alt="clothes"
                                    class="w-full h-40 object-contain mx-auto items-center">
                                <button class="absolute top-2 right-2 text-gray-400 hover:text-red-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4.318 6.318a4.5 4.5 0 011.665-1.227c.919-.391 2.036-.501 3.117.165a5.5 5.5 0 012.9 2.594 5.5 5.5 0 012.9-2.594c1.08-.666 2.198-.556 3.117-.165a4.5 4.5 0 011.665 1.227c1.042 1.042 1.628 2.448 1.628 3.91 0 1.462-.586 2.868-1.628 3.91L12 21.06l-8.682-8.822A5.499 5.499 0 014.318 6.318z" />
                                    </svg>
                                </button>
                            </div>

                            <h3 class="text-[#0f430f] text-base font-bold mt-2 ml-1">Jaket Prada</h3>
                            <p class="text-gray-500 text-sm pt-1 ml-1">Jaket kulit buaya campuran kadal</p>

                            <div class="flex items-center mt-2">
                                <span class="text-orange-400 text-sm font-semibold ml-1">★★★★★</span>
                                <span class="text-gray-500 text-sm ml-1">(121)</span>
                            </div>

                            <p class="text-base font-semibold mt-2 ml-1">IDR. 10.000.000</p>

                            <button
                                class="text-sm mt-4 mb-2 w-full bg-[#0f430f] hover:opacity-80 border text-white py-2 rounded-lg mx-auto block">
                                Add to Cart
                            </button>
                        </div>
        ...
        <div class="bg-white w-full">
            <div class=" max-w-7xl mx-auto p-4 bg-white">
                <!-- Title -->
                <h1 class="text-2xl font-bold mb-6  pl-2 text-[#0f430f] pt-12">Choose Popular Brands</h1>
            ...
            <div class="max-w-8xl mx-auto p-4 pb-16">
                <h1 class="lg:ml-28 text-2xl font-bold mb-6 pl-2 text-[#0f430f] py-6">Get Up To 70% Off</h1>
                <div class="p-1 flex flex-wrap items-center justify-center w-full ">
                    <div
                        ...
                        <div class="relative pt-10 px-10 flex items-center justify-center h-56">
                            <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3"
                                style="background: radial-gradient(black, transparent 60%); transform: rotate3d(0, 0, 1, 20deg) scale3d(1, 0.6, 1); opacity: 0.2;">
                            </div>
                            <img class="relative w-40 object-contain" src="{{ asset('dummy/1.png') }}"
                                alt="">
                        </div>
                    ...
                    <div class="flex-shrink-0 m-2 relative overflow-hidden bg-teal-500 rounded-lg max-w-xs shadow-lg">
                        <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none"
                            style="transform: scale(1.5); opacity: 0.1;">
                            <rect x="159.52" y="175" width="152" height="152" rx="8"
                                transform="rotate(-45 159.52 175)" fill="white" />
                        ...
                        <div class="relative pt-10 px-10 flex items-center justify-center h-56">
                            ...
                            <img class="relative w-40 object-contain" src="{{ asset('dummy/2.png') }}"
                                alt="">
                        </div>
                        <div class="relative text-white px-6 pb-6 mt-6">
                    ...
                    <div
                        class="flex-shrink-0 m-2 relative overflow-hidden bg-purple-500 rounded-lg max-w-xs shadow-lg">
                        <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none"
                            style="transform: scale(1.5); opacity: 0.1;">
                            <rect x="159.52" y="175" width="152" height="152" rx="8"
                                transform="rotate(-45 159.52 175)" fill="white" />
                        ...
                        <div class="relative pt-10 px-10 flex items-center justify-center h-56">
                            ...
                            <img class="relative w-40 object-contain" src="{{ asset('dummy/3.png') }}"
                                alt="">
                        </div>
                        <div class="relative text-white px-6 pb-6 mt-6">
                            <span class="block opacity-75 -mb-1">Outdoor</span>
                    ...
                    <div class="flex-shrink-0 m-2 relative overflow-hidden bg-cyan-500 rounded-lg max-w-xs shadow-lg">
                        <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none"
                            style="transform: scale(1.5); opacity: 0.1;">
                            <rect x="159.52" y="175" width="152" height="152" rx="8"
                                transform="rotate(-45 159.52 175)" fill="white" />
                        ...
                        <div class="relative pt-10 px-10 flex items-center justify-center h-56">
                            ...
                            <img class="relative w-40 object-contain" src="{{ asset('dummy/4.png') }}"
                                alt="">
                        </div>
                        <div class="relative text-white px-6 pb-6 mt-6">
                            <span class="block opacity-75 -mb-1">Outdoor</span>
                            <div class="flex justify-between">
                                <span class="block font-semibold text-xl">Oak Tree</span>
                                <span
                                    class="block bg-white rounded-full text-cyan-500 text-xs font-bold px-3 py-2 leading-none flex items-center">$68.50</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0 m-2 relative overflow-hidden bg-red-500 rounded-lg max-w-xs shadow-lg">
                        ...
                        <div class="relative pt-10 px-10 flex items-center justify-center h-56">
                            ...
                            <img class="relative w-40 object-contain" src="{{ asset('dummy/5.png') }}"
                                alt="">
                        </div>
                        <div class="relative text-white px-6 pb-6 mt-6">
                            <span class="block opacity-75 -mb-1">Outdoor</span>
                            <div class="flex justify-between">
                                <span class="block font-semibold text-xl">Oak Tree</span>
                                <span
                                    class="block bg-white rounded-full text-red-500 text-xs font-bold px-3 py-2 leading-none flex items-center">$68.50</span>
                            </div>
                        </div>
                    </div>
                </div>
